...
if (NOT FFmpeg_FIND_COMPONENTS)
	set(FFmpeg_FIND_COMPONENTS avcodec avdevice avfilter avformat avutil swscale postproc)
...
foreach(comp ${FFmpeg_FIND_COMPONENTS})
	...
	find_path(FFmpeg_${comp}_INCLUDE_DIR
		NAMES "lib${comp}/${comp}.h" "lib${comp}/${comp}ess.h"
		# libpostproc looks for postprocess.h, so NAMES adds the 'ess'. 
		# Not an ideal lookup, but shouldn't affect the other components
		HINTS
